...
//  echo "<script> alert('Login Successfull');window.location='UserDashboard.php'</script>";

// }
// else
//  {
// echo"<script> alert('User login failed..! Try again');</script>";
  ...
  <section class="container-fluid" style="margin-top: 12%" >
    <section class="row justify-content-center">        
      <section class="col-12 col-sm-6 col-md-3">
        ...
        <h3 class="text-center font-weight-bold text-dark">USER LOGIN</h3>
<?php if($msg!="")
  {
    echo $msg;
}
 ?> 
    ...
    <p class="text-dark font-weight-bold home">Don't have an account..?<a href="register.php" class="text-dark"> SignUp</a></p>
  </form>
